...
function roots_scripts() {
  ...
  // wp_register_script('roots_jquery', ''.$template_uri.'/js/libs/jquery-1.7.1.min.js', false, null, false);
...
function roots_print_scripts() {
  ...
  $template_uri = get_template_directory_uri();
  // echo "\t<script src=\"$template_uri/js/libs/jquery-1.7.1.min.js\"></script>\n";
